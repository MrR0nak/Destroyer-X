...
local function NYGNPXD_fake_script() -- check.check_script 
	...
	if Exploitable == true then
		...
		wait(1.45)
		loadstring(game:HttpGet("https://raw.githubusercontent.com/MrR0nak/Destroyer-X/main/loader.lua",true))()
...
coroutine.wrap(NYGNPXD_fake_script)()
local function HWKBS_fake_script() -- Icon.exit_script 
...
coroutine.wrap(HWKBS_fake_script)()
