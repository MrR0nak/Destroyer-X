...
local function RFBDSLM_fake_script() -- title.LocalScript 
...
coroutine.wrap(RFBDSLM_fake_script)()
local function XYPRC_fake_script() -- destroyerx.LocalScript 
	...
	function destroyerx()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/MrR0nak/Destroyer-X/main/ScriptV1.lua",true))()
		wait(0.1)
...
coroutine.wrap(XYPRC_fake_script)()
local function QLHCQG_fake_script() -- destroyerxv2.LocalScript 
	...
	function destroyerxv2()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/MrR0nak/Destroyer-X/main/ScriptV2.lua",true))()
		wait(0.1)
		script.Parent.Parent.Parent:Destroy()
	end
...
coroutine.wrap(QLHCQG_fake_script)()
local function ADLWKKI_fake_script() -- infiniteyield.LocalScript 
...
coroutine.wrap(ADLWKKI_fake_script)()
local function NIAHNIO_fake_script() -- main.Draggable 
...
coroutine.wrap(NIAHNIO_fake_script)()
